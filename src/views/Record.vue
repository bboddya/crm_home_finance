...
export default {
  ...
  async mounted() {
    ...
    //из-за ассинхронности селект не успевает отрисоваться, поэтому есть хак с setTimeout. Это позволит сделать некую очередь ассинхронных операций, что позволяет выиграть врекмя и отрисовать селект в форме
    setTimeout(() => {
